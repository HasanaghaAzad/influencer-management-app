export function ToastMessage({
  ...
  return (
    <section className="fixed top-[80px] right-[80px] z-50 flex max-w-[422px] min-w-[370px] items-center rounded-lg border border-stroke bg-white p-4  shadow-pricing-4 sm:px-[30px] dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark shadow-sm">
      <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-full bg-green-500">
        <svg
          width={24}
          height={25}
          viewBox="0 0 24 25"
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <button className="text-dark-5 hover:text-red" onClick={onClose}>
          <svg
            width={18}
            height={18}
            viewBox="0 0 18 18"
